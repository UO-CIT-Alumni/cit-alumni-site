...
export default class Terms extends Component {
	...
	render (){
		return(
			<Message>
				...
				<p>
				University of Oregon CIT Alumni <br />
				Terms and Conditions ("Terms")	<br />
				Last updated: June 06, 2018 	<br /><br />

	Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the http://www.citalumni.com website (the "Service") operated by University of Oregon CIT Alumni ("us", "we", or "our").<br />
	...
	By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service. This Terms and Conditions agreement for University of Oregon CIT Alumni is powered by TermsFeed.<br /><br />
	...
	Our Service may contain links to third-party web sites or services that are not owned or controlled by University of Oregon CIT Alumni.<br />
	University of Oregon CIT Alumni has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that University of Oregon CIT Alumni shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.<br />
	...
	Governing Law<br />
	These Terms shall be governed and construed in accordance with the laws of Oregon, United States, without regard to its conflict of law provisions.<br />
